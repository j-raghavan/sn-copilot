// UTF-8 codec that works on any JS engine. The Supernote firmware's
// Hermes build has been observed throwing on `new TextEncoder()`,
// likely because the constructor reference is undefined. We try the
// platform globals first for speed and fall back to a portable
// inline implementation so callers don't have to care.
